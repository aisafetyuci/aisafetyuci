      ...
      <div className="container mx-auto px-4 pt-8 pb-16">
        <div className="max-w-3xl mx-auto flex flex-col gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 flex flex-col">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Members participate in workshops, discussions, socials, hackathons, and a weekly reading group on alignment research. While we are a UCI-recognized student group, membership is not restricted to UCI students; independent researchers and students from other universities are welcome.
            </p>
            <p className="text-gray-700 leading-relaxed mb-6">
              If you aren't very familiar with AI safety, we recommend applying to one or both of our fellowships and getting familiar with our <a href="/resources" className="text-[#18234e] underline hover:no-underline">resources</a>. Fellowship alumni typically receive priority in the application process. Admissions are rolling, with decisions made roughly every month.
            </p>
            <div className="mt-auto flex gap-3">
              <a
                href="https://airtable.com/appKZNlVqsXmdMztH/pagMczb6lf65AJyB8/form"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-[#18234e] text-white font-semibold px-6 py-2 rounded hover:bg-[#111a3b] transition"
              >
