      ...
      <div className="w-full bg-[#18234e]">
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-[#f2f3f7] mb-8 pt-8">Nail down fundamentals and explore the community.</p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-6xl mx-auto">
          ...
          <section className="mb-12">
            <h2 className="text-3xl text-[#18234e] font-semibold text-gray-900 mb-6 text-center">Foundational</h2>
          ...
          <section className="mb-12">
            <h2 className="text-3xl text-[#18234e] font-semibold text-gray-900 mb-6 text-center">Technical</h2>
            <div className="grid gap-8 md:grid-cols-3">
          ...
          <section className="mb-12">
            <h2 className="text-3xl text-[#18234e] font-semibold text-gray-900 mb-6 text-center">Training</h2>
            <div className="grid gap-8 md:grid-cols-3">
