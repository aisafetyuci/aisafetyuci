...
export const weeks: Week[] = [
  ...
  {
    number: 7,
    title: 'AGI Strategy & Governance',
    label: 'Week 7',
    objectives: [
      'Reconstruct the strongest version of the "race to AGI" national-security frame, and the strongest version of the case that the race itself is the danger',
      'Evaluate governance levers (compute, export controls, lab security, liability, international coordination) as instruments serving competing strategic theories — not as ends in themselves',
      'Form a defensible view on what a healthy AGI-strategy posture for the US and its allies should look like, and what it would buy us for safety',
    ],
    core: [
      {
    ...
    recommended: [
      ...
      {
        title: 'Beyond the AI Arms Race: America, China, and the Dangers of Zero-Sum Thinking',
        author: 'Zwetsloot, Toner, & Ding',
        year: 2018,
        url: 'https://www.governance.ai/research-paper/beyond-the-ai-arms-race-america-china-and-the-dangers-of-zero-sum-thinking',
        type: 'paper',
      },
      {
  ...
  },
  {
    ...
    label: 'Week 8',
    objectives: [
      'Understand the full ecosystem of AI safety careers beyond technical research',
      'Assess your personal fit across different career paths using structured frameworks',
      'Identify concrete next steps: programs, fellowships, and entry points available now',
    ],
    core: [
      {
    ...
    recommended: [
      {
        title: 'AI Safety Needs More Than Engineers',
        author: 'Avital Morris',
        year: 2026,
        url: 'https://80000hours.org/2026/04/ai-safety-needs-more-than-engineers/',
        type: 'article',
      },
      {
        title: "AI Safety's Biggest Talent Gap Isn't Researchers. It's Generalists.",
        author: 'Topaz, Covarrubias, Bates, Mahajan & Kairos',
        year: 2026,
        url: 'https://forum.effectivealtruism.org/posts/k3nq7FxBCsrNFmAYi/ai-safety-s-biggest-talent-gap-isn-t-researchers-it-s-2',
        type: 'article',
      },
      {
        title: 'How to Use Your Career to Reduce Risks From AI',
        author: '80,000 Hours',
      ...
      {
        title: 'Building the Field of AI Safety',
      ...
      {
        title: 'Planning to Adapt',
        author: 'Benjamin Todd',
        year: 2021,
        url: 'https://80000hours.org/career-planning/process/plan-to-adapt/',
        type: 'article',
      },
      {
        title: 'What 3,654 Job Postings Tell Us About Talent Needs in AI Safety',
        author: 'Weronika Żurek',
        year: 2026,
        url: 'https://forum.effectivealtruism.org/posts/AAGD34wyWHXm5d2gp/what-3-654-job-postings-tell-us-about-talent-needs-in-ai',
        type: 'article',
      },
      {
        title: 'AI Safety and Governance as High-Impact Career Paths',
        author: 'Probably Good',
        url: 'https://probablygood.org/career-profiles/ai-safety-governance/',
        type: 'guide',
      },
    ],
    further: [
      {
        ...
        author: 'Holden Karnofsky',
        year: 2021,
        url: 'https://www.cold-takes.com/call-to-vigilance/',
        type: 'essay',
      },
      {
        title: "The World's Desperate Need for AI Strategists",
        author: 'Miles Brundage & Robert Wiblin',
        url: 'https://80000hours.org/podcast/episodes/the-world-desperately-needs-ai-strategists-heres-how-to-become-one/',
        type: 'article',
      },
      {
        title: 'I Reviewed Hundreds of AI Safety Applications. Here\'s What Actually Matters',
        author: 'Georg Lange',
      ...
      {
        title: 'How to Speedrun Your AI Safety Job Search and Upskilling',
        author: 'EA Forum',
        url: 'https://forum.effectivealtruism.org/posts/jCBtpJovoFgKtpaZP/how-to-speedrun-your-ai-safety-job-search-and-upskilling',
        type: 'article',
      },
    ],
  },
