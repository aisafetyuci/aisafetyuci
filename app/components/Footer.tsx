      ...
      <div className="container mx-auto px-4 py-5 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2 my-3 md:my-0">
          ...
          <div className="flex gap-2">
            <a href={links.coffeeHelena} target="_blank" rel="noopener noreferrer" className="inline-block text-sm bg-[#f2f3f7] text-[#18234e] font-semibold px-4 py-2 rounded-full hover:bg-[#f2f3f7] transition-colors">
              Coffee with Helena
            </a>
            <a href={links.coffeeHarry} target="_blank" rel="noopener noreferrer" className="inline-block text-sm bg-[#f2f3f7] text-[#18234e] font-semibold px-4 py-2 rounded-full hover:bg-[#f2f3f7] transition-colors">
              Coffee with Harry
            </a>
          </div>
        </div>
