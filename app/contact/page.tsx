        ...
        <div className="max-w-4xl mx-auto flex flex-col gap-6">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="mb-6">
              ...
              <a href="https://discord.gg/uENtNdDPPb" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-[#5865F2] text-white font-semibold px-6 py-3 rounded-full hover:bg-[#4752c4] transition-colors">
