        ...
        <div className="max-w-4xl mx-auto flex flex-col gap-6">
          ...
          <div className="surface-card p-5 sm:p-8">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 justify-center">
              {coffeeChats.map((c) => (
                <a key={c.name} href={c.url} target="_blank" rel="noopener noreferrer" className="button-primary text-center">
                  Coffee with {c.name}
                </a>
              ))}
            </div>
          ...
          <div className="surface-card p-5 sm:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <a href={links.discord} target="_blank" rel="noopener noreferrer" className="button-primary w-full">
