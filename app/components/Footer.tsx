    ...
    <footer className="bg-[#00386c] text-indigo-100">
      <div className="container mx-auto px-4 py-5 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2 my-3 md:my-0">
          <span className="text-sm text-indigo-200">Curious about AI safety?</span>
          <div className="flex gap-2">
            ...
            <a href="https://calendar.app.google/mdAMY9qTR4kBcqb88" target="_blank" rel="noopener noreferrer" className="inline-block text-sm bg-indigo-100 text-[#00386c] font-semibold px-4 py-2 rounded-full hover:bg-white transition-colors">
              Coffee with Harry
            </a>
          </div>
        </div>
